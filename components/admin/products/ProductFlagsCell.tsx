...
export function ProductFlagsCell({ id, featured, bestSeller }: { id: string; featured: boolean; bestSeller: boolean }) {
  ...
  return (
    <div className="flex items-center gap-2">
      <button
        ...
        className={cn("rounded-md p-1 transition-colors disabled:opacity-60", featured ? "text-amber-500" : "text-slate-300 hover:text-amber-400")}
      >
      ...
      <button
        ...
        className={cn("rounded-md p-1 transition-colors disabled:opacity-60", bestSeller ? "text-brand-navy" : "text-slate-300 hover:text-brand-navy")}
      >
