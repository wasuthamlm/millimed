    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 gap-4 rounded-2xl border border-slate-100 bg-white p-6 shadow-sm sm:grid-cols-2">
        <div>
          ...
          <select className={inputClass} value={status} onChange={(e) => setStatus(e.target.value as PageFormInput["status"])}>
        ...
        <div className="sm:col-span-2">
          ...
          <input className={inputClass} value={titleTh} onChange={(e) => handleTitleChange(e.target.value)} />
        </div>
