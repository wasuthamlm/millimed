...
// Full Google Consent Mode v2 banner + settings dialog, ported from the Millimed BFS
// site's components/layout/CookieConsent.tsx (necessary/analytics/marketing categories,
// Accept all / Reject all / Customize, footer re-entry point, focus trap) — which was
// itself ported from the legacy millimedbfs.com source app (src/components/public/CookieConsent.jsx).
// Text is hardcoded Thai only, matching that project's scope.
