...
// the visitor opts in. Ported from the Millimed BFS site's lib/consent/trackers.ts.
...
export function loadMetaPixel(pixelId: string | null | undefined): boolean {
  ...
  if (!id || window.__millimedMetaPixelLoaded) return false;
  window.__millimedMetaPixelLoaded = true;
  /* eslint-disable */
...
export function loadTiktokPixel(pixelId: string | null | undefined): boolean {
  ...
  if (!id || window.__millimedTikTokPixelLoaded) return false;
  window.__millimedTikTokPixelLoaded = true;
  /* eslint-disable */
